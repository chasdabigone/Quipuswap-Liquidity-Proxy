...
# Allows the "Governor" address to remove liquidity, claim rewards, transfer tokens or XTZ, and set the Executor address
class LiquidityFundContract(sp.Contract):
    ...
    def addLiquidity(self, param):
        ...
        # DO WE NEED TO APPROVE ON KUSD CONTRACT BEFORE ADD? I DONT KNOW
    ...
    def removeLiquidity(self, amountToRemove):
        ...
        arg = sp.record(min_tez = sp.nat(1), min_tokens = sp.nat(1), shares = amountToRemove)
